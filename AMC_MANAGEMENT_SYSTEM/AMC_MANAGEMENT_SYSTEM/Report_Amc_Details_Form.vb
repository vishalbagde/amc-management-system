...
Public Class Report_Amc_Details_Form
    Dim FromToDate As String = ""

    Private Sub Report_Amc_Details_Form_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        apply_theme(Me)

        Dim detailsTypeDic As New Dictionary(Of String, String)
        detailsTypeDic.Add("1", "AMC Details")
        detailsTypeDic.Add("2", "EMP Wise Details")
    ...
    Private Sub btnSelect_Click(sender As Object, e As EventArgs) Handles btnSelect.Click
        ...
        If service_type = 1 Then 'AMC Details

            If parameter = 1 Then
                FromToDate = "Till Date " + Format(Date.Now, "dd-mm-yyyy")
                query = "select * from contract_Details_view
            ...
            Dim rptDoc As New CrystalReportAmcDetails
        ...
        ElseIf service_type = 2 Then 'emp wise
            ...
            If parameter = 1 Then
                ...
                Else
                    query = "Select * from contract_Details_view
                      where contract_date = '" + Format(temp_date, "MM-dd-yyyy") + "'
                       and sales_by = " + cbEmpId.SelectedItem.key.ToString
                End If
            ...
            Dim rptDoc As New CrystalReportAmcDetailsEmpWise
            rptDoc.SetDataSource(Report_Module.get_dataset_for_crystal_report(query).Tables(0))
            rptDoc.SetParameterValue("FromToDate", FromToDate)
            crvCustomerDetailsView.ReportSource = rptDoc
            crvCustomerDetailsView.Refresh()
